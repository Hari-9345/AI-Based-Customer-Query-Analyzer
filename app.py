...
def generate_response(query, category, sentiment):
    ...
    if category == "Complaint":
        if "broken" in q or "damaged" in q:
            ...
            return "We apologize for the delay. Please check tracking or contact support."
        elif sentiment.startswith("😡"):
            return "We sincerely apologize for the issue. Our support team will resolve it quickly."
        else:
            return "Sorry for the inconvenience. Let us help you."
        ...
        if sentiment.startswith("😊"):
            return "Thank you! We're happy you had a great experience 😊"
        else:
            return "Thanks for your feedback. We will improve."

    return "We’re here to help! Please share more details "
